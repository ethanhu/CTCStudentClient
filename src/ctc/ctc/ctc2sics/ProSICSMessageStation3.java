...
import ctc.sics.station3.elements.semaphore.*;
import ctc.sics.station3.elements.turnout.*;
import ctc.sics.station3.sound.SoundPlayer;

public class ProSICSMessageStation3 {

	BaseParam baseDataForStation = BaseParam.getInstance();
	SoundPlayer SP = SoundPlayer.getInstance(); //播放器
		
	private static ProSICSMessageStation3 proModelStation3 = null;

	public static ProSICSMessageStation3 getInstance() {
		if (proModelStation3 == null) {
			proModelStation3 = new ProSICSMessageStation3();
		}
		return proModelStation3;
	}
