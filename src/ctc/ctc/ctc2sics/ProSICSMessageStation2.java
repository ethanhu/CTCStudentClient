...
import ctc.sics.station2.elements.semaphore.*;
import ctc.sics.station2.elements.turnout.*;
import ctc.sics.station2.sound.SoundPlayer;

public class ProSICSMessageStation2 {

	BaseParam baseDataForStation = BaseParam.getInstance();
	SoundPlayer SP = SoundPlayer.getInstance(); //播放器
		
	private static ProSICSMessageStation2 proModelStation2 = null;

	public static ProSICSMessageStation2 getInstance() {
		if (proModelStation2 == null) {
			proModelStation2 = new ProSICSMessageStation2();
		}
		return proModelStation2;
	}
