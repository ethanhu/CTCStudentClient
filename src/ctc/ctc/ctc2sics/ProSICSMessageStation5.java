...
import ctc.sics.station5.sound.SoundPlayer;

public class ProSICSMessageStation5 {

	BaseParam baseDataForStation = BaseParam.getInstance();
	SoundPlayer SP = SoundPlayer.getInstance(); //播放器
		
	private static ProSICSMessageStation5 proModelStation5 = null;

	public static ProSICSMessageStation5 getInstance() {
		if (proModelStation5 == null) {
			proModelStation5 = new ProSICSMessageStation5();
		}
		return proModelStation5;
	}
