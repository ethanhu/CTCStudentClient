...
import ctc.sics.station1.elements.semaphore.*;
import ctc.sics.station1.elements.turnout.*;
import ctc.sics.station1.sound.SoundPlayer;



public class ProSICSMessageStation1 {

	BaseParam baseDataForStation = BaseParam.getInstance();
	SoundPlayer SP = SoundPlayer.getInstance(); //播放器
		
	private static ProSICSMessageStation1 proModelStation1 = null;

	public static ProSICSMessageStation1 getInstance() {
		if (proModelStation1 == null) {
			proModelStation1 = new ProSICSMessageStation1();
		}
		return proModelStation1;
	}
