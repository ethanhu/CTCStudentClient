...
import ctc.ctc.drawctc.station1.sound.SoundPlayer;
...
public class StationModel {
	...
	// 处理道路相关的内容
	public void processRoad(String startName, String endName, int road_color) {

		//System.out.println("StartName=" + startName + "  EndName=" + endName + "  Color=" + road_color);

		//CTC的变化发送给SICS
		CTCToSICS.sendTaskMessageASYN("标准站一", startName, endName, road_color);
