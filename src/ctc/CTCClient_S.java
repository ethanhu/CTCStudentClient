...
public class CTCClient_S extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		CTCClient_S loginAccess = new CTCClient_S();
