...
public class ParamFlag {
	...
	public static final int turnout_dw_white = 0x000010; //定位白色
	...
	public static final int turnout_fw_white = 0x000011; //反位白色
		
	//--------------股道--------------------//
	public static final int trackline_black = 0x300001; //黑色
	public static final int trackline_bule = 0x300002; //蓝色
	public static final int trackline_green = 0x300003; //绿色
	public static final int trackline_red = 0x300004; //红色
	public static final int trackline_white = 0x300005; //白色
	...
	public static final int sep_blue = 0x400005; //蓝色	
	public static final int sep_green_yellow =  0x400006; //绿黄	
