...
public class BaseParam {
	...
	//hu 2010-7-12
	public static List<SemaphoreDoubleL> sepListSLA = new ArrayList<SemaphoreDoubleL>();	
	public static List<SemaphoreDoubleL> sepListSFA = new ArrayList<SemaphoreDoubleL>();		
	public static List<SemaphoreDoubleR> sepListXLA = new ArrayList<SemaphoreDoubleR>();
	public static List<SemaphoreDoubleR> sepListXFA = new ArrayList<SemaphoreDoubleR>();
	...
	public static List<SemaphoreDoubleL> getSepListSLA() {
		return sepListSLA;
	}

	public static void setSepListSLA(List<SemaphoreDoubleL> sepListSLA) {
		BaseParam.sepListSLA = sepListSLA;
	}

	public static List<SemaphoreDoubleL> getSepListSFA() {
		return sepListSFA;
	}

	public static void setSepListSFA(List<SemaphoreDoubleL> sepListSFA) {
		BaseParam.sepListSFA = sepListSFA;
	}

	public static List<SemaphoreDoubleR> getSepListXLA() {
		return sepListXLA;
	}

	public static void setSepListXLA(List<SemaphoreDoubleR> sepListXLA) {
		BaseParam.sepListXLA = sepListXLA;
	}

	public static List<SemaphoreDoubleR> getSepListXFA() {
		return sepListXFA;
	}

	public static void setSepListXFA(List<SemaphoreDoubleR> sepListXFA) {
		BaseParam.sepListXFA = sepListXFA;
	}
