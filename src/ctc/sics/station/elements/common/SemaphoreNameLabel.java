...
public class SemaphoreNameLabel  extends Label {
	...
	public SemaphoreNameLabel(String buttonName, int X, int Y, String type) {
		...
		this.nameLabel.setLocation(new Point(X + d - buttonName.length() * 3, Y));
		panel.add(this.nameLabel);
		baseData.getSemaphoreNameList().add(nameLabel);
	}
