...
import ctc.sics.station.layout.*;
import ctc.sics.station.autosystem.*;
import ctc.sics.station.buttonListener.*;
...
public class DrawStationGraph {
	...
	public void drawTrackLine1(){
		...
		String trainName = "K22";
		baseData.getX4jj().setTrainName(trainName);
		baseData.getX4jj().getTrainLabel().setText(trainName);
	...
	public void drawSemaphore() {
		...
		allRoadFigureList.add(semaphoreDoubleR);
		baseData.getSepListXLA().add(semaphoreDoubleR);
		//信号机X2JJ
		...
		allRoadFigureList.add(semaphoreDoubleR);		
		// 信号机S1LQ
		semaphoreDoubleL = new SemaphoreDoubleL("S1LQ", X - 6 * len, Y + len + dis, "X");
		semaphoreDoubleL.setColorStatus(ParamFlag.sep_green);
		allRoadFigureList.add(semaphoreDoubleL);	
		baseData.getSepListSFA().add(semaphoreDoubleL);
		// 信号机S2LQ
		...
		allRoadFigureList.add(semaphoreDoubleL);
		//信号机X1LQ
		semaphoreDoubleR = new SemaphoreDoubleR("X1LQ", X + 8 * len, Y - bLen - dis, "S");
		semaphoreDoubleR.setColorStatus(ParamFlag.sep_green);
		allRoadFigureList.add(semaphoreDoubleR);
		baseData.getSepListXFA().add(semaphoreDoubleR);
		//信号机X2LQ
		...
		semaphoreDoubleL.setColorStatus(ParamFlag.sep_green);
		allRoadFigureList.add(semaphoreDoubleL);
		baseData.getSepListSLA().add(semaphoreDoubleL);
		// 信号机S2JJ
...
*/
	...
	public void drawStationButton() {
		...
		stationButton.setLocation(new Point(X - 6 * len - bLen - dis, Y - 2*bLen - dis - 3));
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X - 6 * len - dis + 5, Y - 2*bLen - dis - 3));
		stationButton.setBackgroundColor(bColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X - 6 * len - dis + 5, Y + bLen + dis + 3 + len));
		stationButton.setBackgroundColor(bColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X - 6 * len - bLen - dis, Y + bLen + dis + 3 + len));
		stationButton.setBackgroundColor(yColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X + 8 * len - bLen - 2, Y - 2*bLen - dis - 3));
		stationButton.setBackgroundColor(bColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X + 8 * len + 2, Y - 2*bLen - dis - 3));
		stationButton.setBackgroundColor(yColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X + 8 * len + 2, Y + bLen + dis + 3 + len));
		stationButton.setBackgroundColor(bColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
		...
		stationButton.setSize(bLen, bLen);
		stationButton.setLocation(new Point(X + 8 * len - bLen - 2, Y + bLen + dis + 3 + len));
		stationButton.setBackgroundColor(bColor);
		panel.add(stationButton);
		new MouseAction(stationButton);
		stationButton.addActionListener(new ButtonListener());
