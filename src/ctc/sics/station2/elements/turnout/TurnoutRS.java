...
public class TurnoutRS extends PolylineConnection {
	...
	public TurnoutRS(String name, int initX, int initY, String type) {
		...
		this.type = type;
		this.name = name;
		nameLabel = new TurnoutNameLabel(name, initX + h - 6, initY + 3 * h / 4 - 6);
	...
	public static TurnoutNameLabel getNameLabel() {
		return nameLabel;
	}

	public static void setNameLabel(TurnoutNameLabel nameLabel) {
