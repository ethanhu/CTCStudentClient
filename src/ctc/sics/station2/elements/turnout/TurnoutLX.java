 ...
 * 
 */
public class TurnoutLX extends PolylineConnection {
	 ...
	 * 
     */
	public TurnoutLX(String name, int initX, int initY, String type) {

		this.type = type;		
		this.name = name;
		nameLabel = new TurnoutNameLabel(name, initX - 6, initY + h / 12 + 6);
		...
		trackLineMain.setStart(new Point(initX + h, initY));
		trackLineMain.setEnd(new Point(initX + h / 6, initY));
